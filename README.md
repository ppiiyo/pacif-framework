...
events = np.array([1, 1, 2, 1, 2, 2])      # User actions
contexts = np.array([1, 1, 2, 1, 2, 3])    # System recommendations

result = estimate_alignment(events, contexts)
print(result)
# Output: {'status': 'success', 'mi_estimate': 0.412, 'ci_95': [0.38, 0.44], 'reliable': 
